...
## Identification de l'étudiant
  Nom: Vincen Huang
  Courriel: vincen.huang.1@ens.etsmtl.ca
  Code Moodle: HUAV28019901
  Identifiant Github: VHuangEts
...
1. Le Système affiche le nom du joueur et le résultat de la partie, ainsi que le nombre de parties et le nombre de fois que le Joueur a gagné. Pour un lancer, si le total est égal ou inférieur que dix, le Joueur a gagné. Dans tous les autres cas, il a perdu.
...
1. Le Joeur demande à redémarrer l'application.
...
- Tous les instances de j de Joueur ont été supprimée
![Diagramme de séquence, redemarrerJeu](modeles/rdcu-redemarrerJeu.puml)
